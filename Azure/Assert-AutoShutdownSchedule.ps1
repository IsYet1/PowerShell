...
{	
	...
	$currentTime = (Get-Date).ToUniversalTime().AddHours(-$TZOffset);
	write-output "DM: Current Time is: $currentTime"
	...
	try
	{
	    ...
	    if($TimeRange -like "*->*")
	    {
	        ...
	        if($timeRangeComponents.Count -eq 2)
	        {
                ...
                Write-Output "DM:: Start: $rangeStart || End: $rangeEnd || Current: $currentTime"
